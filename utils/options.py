...
def args_parser():
    ...
    # pancreas_0 example
    '''
    --rounds=50 --num_user=4 --frac=1.0 --local_ep=2 --local_bs=32 --lr=0.001 --model=ClassicNN --dataset=pancreas_0
    --gpu=0 --all_client
    '''
    # federated arguments
    ...
    parser.add_argument('--dim1', type=int, default=2, help='fc1_layer')
    parser.add_argument('--dim2', type=int, default=0, help='fc2_layer')
